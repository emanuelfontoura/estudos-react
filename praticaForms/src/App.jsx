  ...
  return <>
    <form onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <textarea name="msg" id="msg" cols="20" rows="5" value={msg} onChange={({target}) => setMsg(target.value)}/>
      </div>

      <div>
        <select name="opcoes" id="opcoes" value={select} onChange={({target}) => setSelect(target.value)}>
      ...
      <div>
        ...
        <input type="radio" name="sexo" id="imasc" value="M" onChange={handleChangeSexo}/>
        <label htmlFor="ifem">Feminino</label>
        <input type="radio" name="sexo" id="ifem" value="F" onChange={handleChangeSexo}/>
      </div>
